...
def test_help_exits_zero_without_reading_stdin():
    """No stdin fixture on purpose: pytest's captured stdin raises on
    read, so this fails loudly if --help still touched stdin (pre-W2 it
    blocked forever on a TTY)."""
